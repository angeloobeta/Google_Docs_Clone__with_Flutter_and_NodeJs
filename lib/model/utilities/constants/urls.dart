...
//  document urls
const String createDocumentUrl = "${baseUrl}api/docs/create";
const String titleDocumentUrl = "${baseUrl}api/docs/title";
const String documentId = "${baseUrl}api/docs/:id";
const String getAllDocumentUrl = "${baseUrl}api/docs/me";
